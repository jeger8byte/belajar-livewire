...
<div class="py-2">
  ...
  <div class="mt-10">
    <form wire:submit="createUser" method="POST" class="space-y-6">
      ...
      <div>
        <button wire:click.prevent="createUser" type="button" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
      </div>
    </form>
